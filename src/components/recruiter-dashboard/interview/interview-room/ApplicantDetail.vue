...
onMounted(async () => {
    ...
    const response = await interviewAPI.requestApplicantInJobPostingResumeForInterviewRoom(Number(route.params.interviewId))
    if (response.success) {
        const jobpostId = response.results.jobPostingId
        const resumeId = response.results.resumeId
                        ...
                        <div class="mb-6 border-b border-gray-200">
                            <div class="flex gap-8">
                                <button @click="activeTab = 'resume'"
                                    ...
                                    class="hover:cursor-pointer pb-3 border-b-2 font-medium text-sm transition">
                                    이력서
                                </button>
                                <button @click="activeTab = 'coverLetter'"
                                ...
                                <button @click="activeTab = 'pdf'"
                                    ...
                                    class="hover:cursor-pointer pb-3 border-b-2 font-medium text-sm transition flex items-center gap-2">
                                    <Download :size="16" />
                                    PDF
                                </button>
                            </div>
                        ...
                        <div v-if="activeTab === 'resume'" class="space-y-8">
                            ...
                            <div v-if="portfolios.length > 0">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div v-for="file in portfolios" :key="file.id"
                                        ...
                                        <div class="bg-white border border-gray-200 rounded p-3 flex items-center justify-between hover:bg-gray-50 transition cursor-pointer"
                                            ...
                                            <div class="flex items-center gap-2 min-w-0">
                                                <div
                                                    class="w-8 h-8 bg-red-100 rounded flex items-center justify-center flex-shrink-0">
                                                    <FileText :size="16" class="text-red-600" />
                                                </div>
                                                <span class="text-sm text-slate-600 truncate">{{ file.originalFilename
                                                }}</span>
                                            </div>
                                            <Download :size="16" class="text-gray-400 ml-2 flex-shrink-0"
                            ...
                            <div v-if="resumeData.careers.length > 0">
                                ...
                                <div class="space-y-3">
                                    <div v-for="career in resumeData.careers" :key="career.id"
                            ...
                            <div v-if="resumeData.educations.length > 0">
                                ...
                                <div class="space-y-3">
                                    <div v-for="education in resumeData.educations" :key="education.id"
                                        ...
                                        <p class="text-sm text-gray-600">{{ education.major }} ({{ education.degree }})
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-if="resumeData.certificates.length > 0">
                                ...
                                <div class="space-y-2">
                                    <div v-for="cert in resumeData.certificates" :key="cert.id"
                                        class="flex justify-between items-center p-3 bg-white border border-gray-200 rounded">
                            ...
                            <div v-if="resumeData.languages.length > 0">
                                ...
                                <div class="space-y-3">
                                    <div v-for="lang in resumeData.languages" :key="lang.id"
                                        class="p-4 bg-white border border-gray-200 rounded">
                                        <div class="flex justify-between items-start mb-2">
                            ...
                            <div v-if="resumeData.resumeSkills.length > 0">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <span v-for="skill in resumeData.resumeSkills" :key="skill.id"
